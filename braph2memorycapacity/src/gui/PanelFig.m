classdef PanelFig < Panel
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'PanelFig'  'MeasureEnsembleBrainPF'  'MeasureEnsembleBrainPF_GU'  'MeasureEnsembleBrainPF_NU'  'MeasureEnsemblePF'  'MeasureEnsemblePF_GU'  'MeasureEnsemblePF_NU'  'BrainAtlasPF'  'BrainSurfacePF' }; %CET: Computational Efficiency Trick
		end
