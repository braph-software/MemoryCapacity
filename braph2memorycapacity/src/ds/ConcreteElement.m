classdef ConcreteElement < Element
	...
	methods (Static) % inspection
		...
		function subclass_list = getSubclasses()
			...
			subclass_list = { 'ConcreteElement'  'GraphWU'  'AnalyzeEnsemble_CON_WU'  'ExporterGroupSubjectCON_TXT'  'ExporterGroupSubjectCON_XLS'  'ImporterGroupSubjectCON_TXT'  'ImporterGroupSubjectCON_XLS'  'SubjectCON'  'GlobalMemoryCapacity'  'NodalMemoryCapacity'  'AnalyzeEnsemble'  'AnalyzeEnsemblePP_GDict'  'AnalyzeEnsemblePP_MeDict'  'MeasureEnsembleBrainPF'  'MeasureEnsembleBrainPF_GU'  'MeasureEnsembleBrainPF_NU'  'MeasureEnsembleBrainPF_xUPP_Layer'  'MeasureEnsemblePF'  'MeasureEnsemblePF_GU'  'MeasureEnsemblePF_NU'  'MeasureEnsemblePF_NxPP_Node'  'MeasureEnsemblePF_xUPP_Layer'  'PanelPropCellFDR'  'BrainAtlas'  'BrainAtlasPF'  'BrainRegion'  'BrainSurface'  'BrainSurfacePF'  'ExporterBrainAtlasTXT'  'ExporterBrainAtlasXLS'  'ImporterBrainAtlasTXT'  'ImporterBrainAtlasXLS'  'ImporterBrainSurfaceNV'  'Group'  'Subject'  'SubjectPP_VOIDict'  'VOI'  'VOICategoric'  'VOINumeric'  'IndexedDictionary'  'Graph'  'Measure'  'ExporterPipelineBRAPH2'  'GUI'  'GUIElement'  'GUIFig'  'GUILayout'  'ImporterPipelineBRAPH2'  'Panel'  'PanelElement'  'PanelFig'  'PanelProp'  'PanelPropAlpha'  'PanelPropCell'  'PanelPropClass'  'PanelPropClassList'  'PanelPropColor'  'PanelPropIDict'  'PanelPropIDictTable'  'PanelPropItem'  'PanelPropItemList'  'PanelPropLine'  'PanelPropLogical'  'PanelPropMarker'  'PanelPropMatrix'  'PanelPropNet'  'PanelPropOption'  'PanelPropRVectorSmart'  'PanelPropRVectorView'  'PanelPropScalar'  'PanelPropSize'  'PanelPropString'  'PanelPropStringList'  'PanelPropStringTextArea'  'Pipeline'  'PipelineCode'  'PipelinePP_Notes'  'PipelinePP_PSDict'  'PipelineSection'  'Settings'  'SettingsAmbient'  'SettingsAmbientPP'  'SettingsArea'  'SettingsAreaPP'  'SettingsAxis'  'SettingsAxisPP'  'SettingsLine'  'SettingsLinePP'  'SettingsPP'  'SettingsPosition'  'SettingsPositionPP'  'SettingsSphere'  'SettingsSurface'  'SettingsSurfacePP'  'SettingsSymbol'  'SettingsText'  'SettingsTextPP'  'Exporter'  'Importer' }; %CET: Computational Efficiency Trick
		end
