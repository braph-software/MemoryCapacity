classdef NodalMemoryCapacity < Measure
	...
	%  <strong>19</strong> <strong>MC_ALL_TRIALS</strong> 	MC_ALL_TRIALS (result, cell) is the nodal memory capacity at all trials.
	%  <strong>20</strong> <strong>MC_CALC</strong> 	MC_CALC (query, cell) calculates nodal memory capacity, given weighted connectivity matrix, input signal and maximum delay.
	%
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				nodalmemorycapacity_tag_list = { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'SHAPE'  'SCOPE'  'PARAMETRICITY'  'COMPATIBLE_GRAPHS'  'G'  'M'  'PFM'  'TRIALS'  'TRAINING_SAMPLES'  'TAU_MAX'  'MC_ALL_TRIALS'  'MC_CALC' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			nodalmemorycapacity_category_list = { 1  1  1  3  4  2  2  6  1  1  1  1  4  5  9  3  3  3  5  6 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			nodalmemorycapacity_format_list = { 2  2  2  8  2  2  2  2  11  11  11  7  8  16  8  11  11  11  16  16 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 18 % NodalMemoryCapacity.TAU_MAX
					prop_settings = Format.getFormatSettings(11);
				case 19 % NodalMemoryCapacity.MC_ALL_TRIALS
					prop_settings = Format.getFormatSettings(16);
				case 20 % NodalMemoryCapacity.MC_CALC
					prop_settings = Format.getFormatSettings(16);
