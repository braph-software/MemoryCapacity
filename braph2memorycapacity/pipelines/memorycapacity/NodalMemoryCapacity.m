classdef NodalMemoryCapacity < Measure
	...
	methods (Static) % inspection
			...
			if nargin == 0
				prop_list = [ ...
					Measure.getProps() ...
						...
						NodalMemoryCapacity.MC_ALL_TRIALS ...
						NodalMemoryCapacity.MC_CALC ...
						];
				return
			end
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				switch prop
					...
					case NodalMemoryCapacity.MC_ALL_TRIALS
						tag = NodalMemoryCapacity.MC_ALL_TRIALS_TAG;
					case NodalMemoryCapacity.MC_CALC
						tag = NodalMemoryCapacity.MC_CALC_TAG;
					otherwise
		...
		function prop_category = getPropCategory(pointer)
			...
			switch prop
				...
				case NodalMemoryCapacity.MC_ALL_TRIALS
					prop_category = NodalMemoryCapacity.MC_ALL_TRIALS_CATEGORY;
				case NodalMemoryCapacity.MC_CALC
					prop_category = NodalMemoryCapacity.MC_CALC_CATEGORY;
				otherwise
		...
		function prop_format = getPropFormat(pointer)
			...
			switch prop
				...
				case NodalMemoryCapacity.MC_ALL_TRIALS
					prop_format = NodalMemoryCapacity.MC_ALL_TRIALS_FORMAT;
				case NodalMemoryCapacity.MC_CALC
					prop_format = NodalMemoryCapacity.MC_CALC_FORMAT;
				otherwise
		...
		function prop_description = getPropDescription(pointer)
			...
			switch prop
				...
				case NodalMemoryCapacity.MC_ALL_TRIALS
					prop_description = 'MC_ALL_TRIALS (result, cell) is the nodal memory capacity at all trials.';
				case NodalMemoryCapacity.MC_CALC
				...
				case NodalMemoryCapacity.M
					prop_description = 'M (result, cell) is the average nodal memory capacity across all trials.';
				otherwise
		...
		function prop_default = getPropDefault(pointer)
			...
			switch prop
				...
				case NodalMemoryCapacity.TAU_MAX
					prop_default = 35;
				case NodalMemoryCapacity.MC_ALL_TRIALS
					prop_default = Format.getFormatDefault(Format.CELL, NodalMemoryCapacity.getPropSettings(prop));
				case NodalMemoryCapacity.MC_CALC
					prop_default = Format.getFormatDefault(Format.CELL, NodalMemoryCapacity.getPropSettings(prop));
				case NodalMemoryCapacity.ELCLASS
		...
		function prop_check = checkProp(pointer, value)
			...
			switch prop
				...
				case NodalMemoryCapacity.TAU_MAX % __NodalMemoryCapacity.TAU_MAX__
					check = Format.checkFormat(Format.SCALAR, value, NodalMemoryCapacity.getPropSettings(prop));
				case NodalMemoryCapacity.MC_ALL_TRIALS % __NodalMemoryCapacity.MC_ALL_TRIALS__
					check = Format.checkFormat(Format.CELL, value, NodalMemoryCapacity.getPropSettings(prop));
				case NodalMemoryCapacity.MC_CALC % __NodalMemoryCapacity.MC_CALC__
					check = Format.checkFormat(Format.CELL, value, NodalMemoryCapacity.getPropSettings(prop));
	...
	methods (Access=protected) % calculate value
		function value = calculateValue(m, prop, varargin)
			...
			switch prop
				case NodalMemoryCapacity.MC_ALL_TRIALS % __NodalMemoryCapacity.MC_ALL_TRIALS__
					rng_settings_ = rng(); rng(m.getPropSeed(NodalMemoryCapacity.MC_ALL_TRIALS), 'twister')
