function create_data_memorycapacity(data_dir, random_seed)
%create_data_memorycapacity: creates connectivity data
%
% create_data_memorycapacity() creates connectivity data in default folder
% 'Example Data memory capacity'.
%
% create_data_memorycapacity(DATA_DIR) creates connectivity data in DATA_DIR folder.
%
% create_data_memorycapacity(DATA_DIR, RANDOM_SEED) cretes connectivity data in
